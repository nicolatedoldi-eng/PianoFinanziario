...
<!DOCTYPE html>
<html lang="it">
<head><meta charset="utf-8"><title>Il tuo piano finanziario \u00e8 pronto</title></head>
<body style="font-family:system-ui,sans-serif;background:#F9FAFB;margin:0;padding:40px 20px;">
  <div style="max-width:600px;margin:0 auto;background:white;border-radius:16px;border:1px solid #E5E7EB;overflow:hidden;">
    <div style="background:#534AB7;padding:32px;text-align:center;">
      <div style="display:inline-block;background:white;border-radius:8px;padding:6px 12px;margin-bottom:12px;">
        <span style="color:#534AB7;font-weight:700;">PianoFinanziario</span>
      </div>
      <h1 style="color:white;margin:0;font-size:24px;font-weight:700;">Il tuo piano finanziario \u00e8 pronto \ud83c\udf89</h1>
    </div>
    <div style="padding:32px;">
      <p style="color:#374151;margin-bottom:24px;">
        Ciao! Il tuo profilo <strong>${profileName}</strong> \u00e8 stato creato con successo.
        Ecco cosa fare nei prossimi giorni per iniziare concretamente.
      </p>
      <div style="background:#EEF0FB;border-radius:12px;padding:20px;margin-bottom:28px;">
        <h2 style="color:#534AB7;margin:0 0 16px;font-size:18px;">I tuoi primi 3 passi concreti</h2>
        ${stepsHtml}
      </div>
      <p style="color:#6B7280;font-size:14px;margin-bottom:24px;">
        Ricorda: la costanza batte il timing. Anche piccoli versamenti mensili,
        nel lungo periodo, producono risultati sorprendenti grazie all'interesse composto.
      </p>
      <a href="${dashboardUrl}"
         style="display:block;background:#534AB7;color:white;text-decoration:none;text-align:center;padding:16px;border-radius:12px;font-weight:700;font-size:16px;">
        Vai alla tua dashboard \u2192
      </a>
    </div>
    <div style="padding:20px 32px;border-top:1px solid #E5E7EB;text-align:center;">
      <p style="color:#9CA3AF;font-size:12px;margin:0;">
        Questo \u00e8 uno strumento educativo, non consulenza finanziaria.<br />
    ...
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: FROM_EMAIL,
        to: email,
        subject: 'Il tuo piano finanziario \u00e8 pronto \ud83c\udf89',
        html,
      }),
    })
