...
const FROM_EMAIL = 'EasiVest <info@easivest.com>'
...
<div style="max-width:600px;margin:0 auto;background:white;border-radius:16px;border:1px solid #E5E7EB;overflow:hidden;">
  ...
  <div style="padding:32px;">
    ...
    <p style="color:#9CA3AF;font-size:12px;line-height:1.6;margin:0 0 16px;">EasiVest è uno strumento educativo. I rendimenti mostrati sono stime basate sui dati storici e non garantiscono risultati futuri. Non gestiamo i tuoi soldi e non siamo consulenti finanziari.</p>
