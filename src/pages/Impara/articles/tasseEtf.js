export const tasseEtfContent = [
  ...
  { type: 'p', text: "Con un broker italiano in regime amministrato (Fineco, Directa, Trade Republic), le tasse vengono calcolate e versate automaticamente dal broker. Non devi dichiarare nulla nel 730." },
