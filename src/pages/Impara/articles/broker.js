export const brokerContent = [
  ...
  { type: 'h2', text: 'Confronto tra i principali broker' },
  {
    ...
    rows: [
      ...
      ['Scalable Capital', '\u20ac0 (piano Free, 1 ETF/mese) o \u20ac2,99/mese illimitato', 'Amministrato', 'PAC automatici, principianti'],
  ...
  { type: 'p', text: "Con un broker italiano in regime amministrato (Fineco, Scalable, Trade Republic), le tasse vengono calcolate e versate automaticamente dal broker. Non devi fare nulla in dichiarazione dei redditi per questi investimenti." },
